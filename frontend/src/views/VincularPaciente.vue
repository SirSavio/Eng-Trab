      ...
      >
        <div class="modal-content text-center py-4 text-left px-6">
          <div class="flex justify-between items-center text-center pb-3">
            <p class="text-2xl font-bold text-center text-green-500">Notificação enviada!</p>
            <div
        ...
        <div class="text-xl">
            <p>Aguardando confirmação do paciente</p>
                <p>Após a conclusão você será redirecionado para a tela de vínculo</p>
                <div align="center">
                    <img class="mt-3" width="50" src="https://c.tenor.com/I6kN-6X7nhAAAAAj/loading-buffering.gif"/>
                </div>
