<template>
  <div class="flex">
    ...
    <div
      ...
      class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-green-500 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0 lg:rounded-none"
    >
